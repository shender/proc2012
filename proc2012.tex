...
\begin{tikzpicture}
  \pdtitle{Паша + Стас}{5 капитанов + К}
  \pdcall{<-}{2}{0}{1}{П.Х.}{К.А.};
  \pdcall{->}{1}{6}{0}{П.Х.}{Д.М.};
  \pdcall{<-}{6}{2}{0}{П.Х.}{Т.К.};
  \pdcall{->|}{4}{2}{0}{П.Х.}{Д.Т.};
  \pdcall{<-}{3}{2}{0}{П.Х.}{Е.Б.};
  \pdcall{->|}{5}{-6}{0}{П.Х.}{Ф.Б.};
  \pdsum{6}{1}{65};
\end{tikzpicture}

\bigskip

\textit{Паша + Стас:} Павел Ходунов и Станислав Крымский.

\textit{5 капитанов + К:} Кирилл Антонов, Дмитрий Морозов, Тимофей
